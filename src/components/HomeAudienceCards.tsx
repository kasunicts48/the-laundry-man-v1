                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                    <div className="flex items-center gap-2">
                      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gold text-paper shadow-md">
                        <Icon className="h-4 w-4" aria-hidden="true" />
                      </span>
                      <p className="text-xs font-medium tracking-wide text-paper">{card.eyebrow}</p>
                    </div>
                  </div>
                </div>

                <div className="flex flex-1 flex-col bg-paper p-5 sm:p-6">
                  <h3 className="text-xl font-semibold tracking-tight text-slate sm:text-2xl">
                    {card.title}
                  </h3>
                  ...
                  <div className="mt-5 pt-1">
                    <BookNowButton fullWidth label="Schedule your collection" />
                  </div>
                </div>
              </article>
            );
